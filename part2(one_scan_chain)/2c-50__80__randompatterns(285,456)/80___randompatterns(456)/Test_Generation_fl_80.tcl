set_messages -log ./test_gen_fl_80.log -replace
...
remove_faults -all
set_patterns -delete
set_patterns  -external ./ATPG_pattern_fs_80.pattern
set_faults -model stuck
add_faults -all
run_fault_sim
report_faults -summary
write_faults ./ATPG_pattern_fl_80.left -class UD -class PT -class AU -class ND -replace
exit
