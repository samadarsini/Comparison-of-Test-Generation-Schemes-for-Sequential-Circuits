set_messages -log ./test_gen_fs_30.log -replace
...
set_patterns -external ./random_pattern_30.pattern

set_simulation -measure sim
run_simulation -update
write_patterns ./ATPG_pattern_fs_30.pattern -exclude setup -format stil -external -replace
