with open("/content/pattern_format.pattern", 'r') as f:
    format = f.read()
random_pattern_30='random_pattern_30.pattern'
with open(random_pattern_30, 'w') as file:
    file.write(format)
with open("/content/test30_1b.txt", 'r') as infile:
    ...
    for i, line in enumerate(lines):
        ...
        with open(random_pattern_30, 'a') as file:
