set_messages -log ./test_gen_fs_80.log -replace
...
remove_faults -all
set_patterns -delete
set_patterns  -external ./random_pattern_80.pattern
set_simulation -measure sim
run_simulation -update
write_patterns ./ATPG_pattern_fs_80.pattern -exclude setup -format stil -external -replace
exit
